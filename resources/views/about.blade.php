					...
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<li class="active"><a href="{{asset('assets/frontend/about.html')}}">About Me</a></li>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 breadcrumbs text-center">
						<h2>About Me</h2>
						<p><span><a href="{{asset('assets/frontend/index.html')}}">Home</a></span> / <span>About</span></p>
					</div>
				</div>
			</div>
		</aside>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<p class="first-letra">Far far away, <strong><a href="{{asset('assets/frontend/#')}}'">behind the word mountains</a></strong>, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
						<p>
							<ul class="colorlib-social-icons">
								<li><a href="{{asset('assets/frontend/#')}}'"><i class="icon-twitter"></i></a></li>
								<li><a href="{{asset('assets/frontend/#')}}'"><i class="icon-facebook"></i></a></li>
								<li><a href="{{asset('assets/frontend/#')}}'"><i class="icon-linkedin"></i></a></li>
								<li><a href="{{asset('assets/frontend/#')}}'"><i class="icon-dribbble"></i></a></li>
							</ul>
						</p>
					</div>
				</div>
