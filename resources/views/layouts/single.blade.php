					...
					<div class="col-md-9 content">
						...
						<div class="row row-pb-lg">
							<div class="col-md-12">
								...
								<div class="review">
						   		<div class="user-img" style="background-image: url({{asset('assets/frontend/images/person1.jp')}}g)"></div>
						   		<div class="desc">
						   			<h4>
						   	...
						   	<div class="review">
						   		<div class="user-img" style="background-image: url({{asset('assets/frontend/images/person2.jp')}}g)"></div>
						   		<div class="desc">
						   			<h4>
						   				<span class="text-left">Jacob Webb</span>
						   				<span class="text-right">24 March 2018</span>
						   	...
						   	<div class="review">
						   		<div class="user-img" style="background-image: url({{asset('assets/frontend/images/person3.jp')}}g)"></div>
						   		<div class="desc">
						   			<h4>
						   				<span class="text-left">Jacob Webb</span>
						   				<span class="text-right">24 March 2018</span>
